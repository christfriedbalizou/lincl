...
[![CI status](https://img.shields.io/github/actions/workflow/status/christfriedbalizou/lincl/ci.yml?branch=main&style=for-the-badge&label=CI)](https://github.com/christfriedbalizou/lincl/actions/workflows/ci.yml)
[![CodeQL status](https://img.shields.io/github/actions/workflow/status/christfriedbalizou/lincl/codeql.yml?branch=main&style=for-the-badge&label=CodeQL)](https://github.com/christfriedbalizou/lincl/actions/workflows/codeql.yml)
[![PyPI version](https://img.shields.io/pypi/v/lincl.svg?style=for-the-badge&cacheSeconds=300)](https://pypi.org/project/lincl/)
[![Supported Python versions](https://img.shields.io/pypi/pyversions/lincl.svg?style=for-the-badge)](https://pypi.org/project/lincl/)
...
word_count = count_words("-w", "README.md").value
```
...
the archive, calculates its checksum, and reports its size. Compare the three
implementations to see their process-management overhead directly.
...
Found a bug or have an idea? Open an issue in the [GitHub issue tracker]. A
...
[GitHub issue tracker]: https://github.com/christfriedbalizou/lincl/issues
[MIT License]: https://github.com/christfriedbalizou/lincl/blob/main/LICENSE
